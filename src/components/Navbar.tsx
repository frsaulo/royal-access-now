...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gold backdrop-blur-md border-b border-gold-light/30">
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="md:hidden bg-gold border-t border-gold-light/30"
          >
